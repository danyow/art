...
namespace UnityEditor.U2D.ART
{
    ...
    internal class TextureSettings: ITextureSettings
    {
        ...
        public int aniso{ get { return m_Aniso; } set { m_Aniso = value; } }
    ...
    internal class TextureSpriteSettings: ITextureSettings
    {
        ...
        public string packingTag{ get { return m_PackingTag; } set { m_PackingTag = value; } }
        ...
        public uint extrudeEdges{ get { return m_ExtrudeEdges; } set { m_ExtrudeEdges = value; } }
    ...
    internal class TextureAlphaSettings: ITextureSettings
    {
        ...
        public float alphaTolerance{ get { return m_AlphaTolerance; } set { m_AlphaTolerance = value; } }

        [SerializeField]
        TextureImporterAlphaSource m_AlphaSource;

        public TextureImporterAlphaSource alphaSource{ get { return m_AlphaSource; } set { m_AlphaSource = value; } }
    ...
    internal class TextureMipmapSettings: ITextureSettings
    {
        ...
        public TextureImporterMipFilter filter{ get { return m_Filter; } set { m_Filter = value; } }

        [SerializeField]
        bool m_BorderMipmap;

        public bool borderMipmap{ get { return m_BorderMipmap; } set { m_BorderMipmap = value; } }
        ...
        public bool preserveCoverage{ get { return m_PreserveCoverage; } set { m_PreserveCoverage = value; } }

        [SerializeField]
        int m_FadeDistanceStart;

        public int fadeDistanceStart{ get { return m_FadeDistanceStart; } set { m_FadeDistanceStart = value; } }

        [SerializeField]
        int m_FadeDistanceEnd;

        public int fadeDistanceEnd{ get { return m_FadeDistanceEnd; } set { m_FadeDistanceEnd = value; } }
    ...
    internal class TextureNormalSettings: ITextureSettings
    {
        ...
        public TextureImporterNormalFilter filter{ get { return m_Filter; } set { m_Filter = value; } }

        [SerializeField]
        bool m_GenerateFromGrayScale;

        public bool generateFromGrayScale{ get { return m_GenerateFromGrayScale; } set { m_GenerateFromGrayScale = value; } }

        [SerializeField]
        float m_Bumpiness;

        public float bumpiness{ get { return m_Bumpiness; } set { m_Bumpiness = value; } }
    ...
    internal class TextureCubemapSettings: ITextureSettings
    {
        ...
        public TextureImporterCubemapConvolution convolution{ get { return m_Convolution; } set { m_Convolution = value; } }

        [SerializeField]
        TextureImporterGenerateCubemap m_Mode;

        public TextureImporterGenerateCubemap mode{ get { return m_Mode; } set { m_Mode = value; } }

        [SerializeField]
        bool m_Seamless;

        public bool seamless{ get { return m_Seamless; } set { m_Seamless = value; } }
    ...
    internal static class TextureGeneratorHelper
    {
        ...
        {
            if(alphaSettings == null) alphaSettings = new TextureAlphaSettings(TextureImporterAlphaSource.FromInput, 0.5f);
        ...
        public static TextureGenerationOutput GenerateLightmap(
            NativeArray<Color32> buffer,
            int bufferWidth,
            int bufferHeight,
            TextureSettings settings,
        ...
        public static TextureGenerationOutput GenerateCookie(
            NativeArray<Color32> buffer,
            int bufferWidth,
            int bufferHeight,
            TextureSettings settings,
            ...
            TextureAlphaSettings alphaSettings = null,
            TextureMipmapSettings mipmapSettings = null,
            TextureCubemapSettings cubemapSettings = null,
            TextureWrapSettings wrapSettings = null
        )
        {
            return GenerateTexture(
        ...
        public static TextureGenerationOutput GenerateNormalMap(
            NativeArray<Color32> buffer,
            int bufferWidth,
            int bufferHeight,
            TextureSettings settings,
        ...
        public static TextureGenerationOutput GenerateTextureGUI(
            NativeArray<Color32> buffer,
            int bufferWidth,
            int bufferHeight,
            TextureSettings settings,
        ...
        public static TextureGenerationOutput GenerateTextureSingleChannel(
            NativeArray<Color32> buffer,
            int bufferWidth,
            int bufferHeight,
            TextureSettings settings,
        ...
        public static TextureGenerationOutput GenerateTextureCursor(
            NativeArray<Color32> buffer,
            int bufferWidth,
            int bufferHeight,
            TextureSettings settings,
        ...
        public static TextureGenerationOutput GenerateTextureDefault(
            NativeArray<Color32> buffer,
            int bufferWidth,
            int bufferHeight,
            TextureSettings settings,
        ...
        {
            if(mipmapSettings == null) mipmapSettings = new TextureMipmapSettings(TextureImporterMipFilter.BoxFilter, false, false, false, 1, 3);
        ...
        )
        {
            ...
            {
                if(otherSetting != null) otherSetting.FillTextureGenerationSettings(ref textureGenerationSettings);
            }
        ...
        {
            if(settings.alphaIsTransparency == false) return null;
        ...
        {
            if(!settings.mipmapEnabled) return null;
        ...
        {
            if(settings.textureShape != TextureImporterShape.TextureCube) return null;
